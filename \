            ...
            <form className='space-y-6' onSubmit={(e) => e.preventDefault()} aria-label='Monitoring settings'>
                ...
                <div className='space-y-4'>
                  <div>
                    <div className='flex justify-between items-center mb-2'>
                      <Label htmlFor='failure-rate' className='body-sm text-[var(--on-surface)] font-normal'>Failure Rate Alert</Label>
                      <span className='data-mono text-[var(--primary)]' aria-live='polite'>&gt; 5%</span>
                    </div>
                  ...
                  <div>
                    <div className='flex justify-between items-center mb-2'>
                      <Label htmlFor='queue-depth' className='body-sm text-[var(--on-surface)] font-normal'>Queue Depth Alert</Label>
                      <span className='data-mono text-[var(--primary)]' aria-live='polite'>&gt; 500</span>
                    </div>
              ...
              <div className='pt-4 border-t border-[var(--border-subtle)]'>
                ...
                <div className='space-y-3'>
                  <label htmlFor='channel-email' className='flex items-center gap-3 p-2 hover:bg-[var(--surface-container)] rounded-md cursor-pointer transition-colors border border-transparent hover:border-[var(--border-subtle)]'>
                  ...
                  <label htmlFor='channel-slack' className='flex items-center gap-3 p-2 hover:bg-[var(--surface-container)] rounded-md cursor-pointer transition-colors border border-transparent hover:border-[var(--border-subtle)]'>
                  ...
                  <label htmlFor='channel-sms' className='flex items-center gap-3 p-2 hover:bg-[var(--surface-container)] rounded-md cursor-pointer transition-colors border border-transparent hover:border-[var(--border-subtle)] opacity-60'>
              ...
              <div className='pt-4 border-t border-[var(--border-subtle)] flex gap-3'>
                <Button type='submit' className='flex-1 bg-[var(--primary)] text-[var(--on-primary)] hover:bg-[var(--on-primary-fixed-variant)]'>Save Settings</Button>
                <Button type='button' variant='outline' className='border-[var(--border-subtle)] bg-[var(--surface-container)]'>Test Alert</Button>
              </div>
            </form>
          </Card>
